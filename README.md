...
```bash
git clone https://github.com/outwake/Conta_Bancaria.git
```
...
**Lary, a pioral — Desenvolvedora Full Stack**

🔗 **GitHub:** https://github.com/outwake

🔗 **LinkedIn:** https://www.linkedin.com/in/larissa-ferreira-mendonça-49655a185/
